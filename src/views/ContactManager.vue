    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col">
                ...
                <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi laborum cupiditate provident praesentium dolores quidem unde aspernatur quibusdam veniam quam. Quod rem quas libero tempore eius cupiditate vel! Recusandae, numquam.</p>
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row">
                ...
                <div class="card my-2 list-group-item-success shadow-lg">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-sm-4">
                                <img :src="contact.photo" alt="user_image" class=" contact-img">
                            </div>
                            <div class="col-sm-7">
                                <ul class="list-group">
